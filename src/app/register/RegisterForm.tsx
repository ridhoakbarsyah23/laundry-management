      ...
      <div className="flex-1">
        ...
        <div className="space-y-3">
          <Button 
            ...
            className="w-full h-12 rounded-xl border-slate-200 text-slate-700 font-semibold hover:bg-slate-50 flex items-center justify-center gap-3 transition-colors"
          >
